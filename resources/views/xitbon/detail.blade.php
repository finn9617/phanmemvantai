...
<section class="content-header">
  <div class="row">
    <div class="col-md-12 titleDieuXe"> THÔNG TIN XỊT BỒN </div>
  </div>
          <!-- back page -->
  <div class="row">
                            ...
                            <form action="/xitbon/create" method="post" name="itemForm" id="acountForm">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6" >
                                        ...
                                        <input type="text" class="form-control" value="{{$xit->clear_tank_name}}" name="txtTen" id="txtTen" placeholder="Nhập tên xịt bồn" >
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        <label for="comment">Thông tin xịt bồn :</label>
                                        <textarea class="form-control" rows="7" cols="10" id="txtThongtin" name="txtThongtin" placeholder="Thông tin loại rơ mooc">{{ $xit->note }}</textarea>
                                    </div>
                                </div>
                                <div class="row">
    ...
    <script type="text/javascript">
         $(document).ready(function (){
            $('#btnOk').click(function(e){
                ...
                data.append('note', $("#txtThongtin").val());
                data.append('id', "{{ $xit->clear_tank_id }}" );

                $.ajax({
                    data:data,
                    url: "{{ url('/xitbon/detail')}}",
                    type: "POST",
                    headers: {
