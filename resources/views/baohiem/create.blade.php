...
<section class="content-header">
    <div class="row">
        <div class="col-md-12 titleDieuXe"> THÊM MỚI BẢO HIỂM  </div>
    </div>
    <div class="row">
        <div class="col-md-12 prePage">
        <a href="{{ route('showBaoHiem') }}" onclick="back()" class="" id="back">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-warning col-md-11">
                <div class="box-body">
                    <form action="/baohiem/create" method="post" name="itemForm" id="acountForm">
                        <div class="row">
