...
<section class="content-header">
    <div class="row">
        <div class="col-md-12 titleDieuXe"> THÊM MỚI BÁO THAY NHỚT  </div>
    </div>
    <div class="row">
                    ...
                    <form action="/baoduong/create" method="post" name="itemForm" id="acountForm">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="txtSocu" id="txtSocu" placeholder="Nhập số km công tơ củ..." value="">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="somoi">Số km công tơ mới (*):</label><label style="color: red; font-size: 13px"><i id="error-date"></i></label>
                                <input type="text" class="form-control" name="txtSomoi" id="txtSomoi" placeholder="Nhập số km công tơ mới..." value="">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="sothay">Số km cần thay nhớt (*):</label><label style="color: red; font-size: 13px"><i id="error-date"></i></label>
                                <input type="text" class="form-control" name="txtSothay" id="txtSothay" placeholder="Nhập số km cần thay..." value="">
                            </div>
                        </div>
