...
<section class="content-header">
    <div class="row">
        <div class="col-md-12 titleDieuXe"> THÊM MỚI KIỂM ĐỊNH </div>
    </div>
    <div class="row">
        <div class="col-md-12 prePage">
        <a href="{{ route('showV') }}" onclick="back()" class="" id="back">
                <span class="glyphicon glyphicon-step-backward">
                    <span class="prePage">DANH SÁCH KIỂM ĐỊNH</span>
                </span>
            </a>
        </div>
    </div>
            ...
            <div class="box box-warning col-md-11">
                <div class="box-body">
                    <form action="/verify/create" method="post" name="itemForm" id="acountForm">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="email">Số phiếu kiểm định (*):</label><label style="color: red; font-size: 13px"><i id="error-sophieu"></i></label>
