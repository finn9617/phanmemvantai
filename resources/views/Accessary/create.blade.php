    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            <form id="createAccessary" name="createAccessary">
                <h1>Thêm mới phụ tùng xe</h1>
                <input type="hidden" id="_token" name="_token" value="{{csrf_token()}}">
                <div class="row">
                    <div class="form-group col-md-6">
                        <label for="fullname">Tên đầy đủ phụ tùng (*) <i><span style="color:red" id="errorFullname"></span></i></label>
                        <input type="text" class="form-control" id="fullname" name="fullname" placeholder="Nhập tên đầy đủ phụ tùng">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="fullname">Tên thay thế phụ tùng</label>
                        <input type="text" class="form-control" id="shortname" name="shortname" placeholder="Nhập tên viết tắt phụ tùng">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="fullname">Đơn vị tính</label>
                        <input type="text" class="form-control" id="unit" name="unit" placeholder="Nhập đơn vị tính phụ tùng">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="fullname">Vị trí</label>
                        <input type="text" class="form-control" id="position" name="position" placeholder="Nhập vị trí phụ tùng">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="fullname">Tồn dưới</label>
                        <input type="text" class="form-control" id="remain" name="remain" placeholder="Nhập số lượng tồn dưới sẽ báo">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="fullname">Giá hiện tại</label>
                        <input type="text" class="form-control" id="price" name="price" placeholder="Nhập giá hiện tại">
                    </div>
                    <div class="form-group col-md-12">
                        <label class="form-group container">Không nhập <i><span style="color:red">Lưu ý: Khi chọn vào đây thì phụ tùng trong kho hết sẽ không có thông báo</span></i>
                            <input type="checkbox" class="form-control" id="unimport" name="unimport">
