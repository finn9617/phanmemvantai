...
@section('content')
    ...
    <section class="content">
        ...
        @endif
        {{-- form start --}}
    <form role ="form" action="/noigiaonhan/create" method="POST" id="place">
        {!! csrf_field() !!}
        <div class="col-md-12">
            <div class="row">
                <div class=" box box-primary">
                    ...
                    <div class="form-group">
                        ...
                        <select name="selLoaihinh" id="selLoaihinh" class="form-control">
                    ...
                    <div id="formgiao">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="txtTenkho" name="txtTenkho" placeholder="Nhập tên nơi giao" >
                        </div>
                        </div>
                        <div class="col-md-6">
                        <div class="form-group">
                            <label for="" class="control-label">Địa chỉ</label>
                            <input type="text" class="form-control" id="txtDiachi" name="txtDiachi" placeholder="Nhập địa chỉ nơi giao" >
                        </div>
                        </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="control-label">Thông tin người liên hệ </label>
                            <textarea class="form-control" rows="3" placeholder="Nhập thông tin người liên hệ" name="txtInfonguoilh"></textarea>
                        </div>
                        <div class="form-group">
                            <label for="" class="control-label">Thông tin kho </label>
                            <textarea class="form-control" rows="3" placeholder="Nhập thông tin kho giao hàng" name="txtInfokho"></textarea>
                        </div>
