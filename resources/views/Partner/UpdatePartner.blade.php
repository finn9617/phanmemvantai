  ...
  $('.select2').select2(
  {
                      ...
                      <div class="box box-primary">
                        <div class="box-body box-profile">
                          @if(isset($partner->img))
                            <img class="profile-user-img img-responsive img-circle" src="{{ url('img/anhchuhang/'. $partner->img) }}" alt="User profile picture">
                          @else
                          ...
                          <ul class="list-group list-group-unbordered">
                            <li class="list-group-item">
                              <b>Công ty</b> <a class="pull-right"><i>{{ $partner->partner_full_name }}</i></a>
                            </li>
                            <li class="list-group-item">
                              <b>Mã số thuế</b><a class="pull-right"><i>{{ $partner->tax_num }}</i></a>                          
                            </li>
                            <li class="list-group-item">
                            <b>Số điện thoại</b> <a class="pull-right"><i>{{ $partner->phone }}</i></a>
                            </li>
                          </ul>
                        </div>
                        <!-- /.box-body -->
                          ...
                          {{ csrf_field() }}
                            ...
                            <div class="form-group">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="txtOwnerName" name="txtOwnerName" placeholder="Enter Owner Name" value="{{$partner->partner_full_name}}"> 
                              </div>
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="txtShortName" name="txtShortName" placeholder="Enter Short Name" value="{{$partner->partner_short_name}}"> 
                              </div>
                              <div class="form-group">
                                <label for="address" class="form-label">Địa chỉ</label>
                                <input type="text" class="form-control" id="txtAddress" name="txtAddress" placeholder="Enter Address" value="{{$partner->address}}">
                              </div>
                              <div class="form-group">
                                <label for="MST" class="control-label">Mã số thuế <span style="color:red;" class="errortxtMST" id="errortxtMST"></span></label>
                                <input type="text" class="form-control" id="txtMST" name="txtMST" placeholder="Enter Tax Number" value="{{$partner->tax_num}}">
                              </div>
                              <div class="form-group">
                                <label for="phone" class="control-label">Số điện thoại <span style="color:red;" class="errortxtPhone" id="errortxtPhone"></span></label>
                                <input type="text" class="form-control" id="txtPhone" name="txtPhone" placeholder="Enter Phone Number" value="{{$partner->phone}}">
                              </div>
                              <div class="form-group">
                                <label for="email" class="form-label">Email đăng nhập<span style="color:red;" class="errortxtEmail" id="errortxtEmail"></span></label>
                                <input type="text" class="form-control" id="txtEmail" name="txtEmail" placeholder="Enter Email" value="{{$partner->email}}">
                              </div>
                              <div class="form-group">
                               ...
                               <!--  <input type="text" class="form-control" id="txtEmailContact" name="txtEmailContact" placeholder="Enter Email" value="{{$partner->email_contact}}"> -->
                               <textarea class="form-control" id="txtEmailContact" name="txtEmailContact" placeholder="Enter Email">{{$partner->email_contact}}</textarea>
                              </div>
                              <div class="form-group">
                                  <label for="suggestGoods" class="form-label"> Ảnh đại diện: <span style="color:red;" class="errorfileanh" id="errorfileanh"></span></label>
                                  <br>
                                  <img src="{{ url('img/anhchuhang/'. $partner->img) }}" alt="" class="output_image">
                                  <br><br>
                              ...
                              <div class="form-group">
                                ...
                                <textarea class="form-control" id="txtContact" name="txtContact" placeholder="Enter Contact" >{{ $partner->contact_note }}</textarea>
                              </div>
                              <div class="form-group">
                                <label for="note" class="form-label">Ghi chú</label>
                                <textarea class="form-control" id="txtNote" name="txtNote" placeholder="Enter Note">{{ $partner->note }}</textarea>
                              </div>
                              <div class="form-group">
                                <label for="note" class="form-label">Gợi ý số lượng <span style="color:red;" class="errortxtAmount" id="errortxtAmount"></span></label>
                                <input type="text" class="form-control" id="txtAmount" name="txtAmount" placeholder="Nhập số lượng" value="{{ $partner->num }}">
                              </div>
                              <div class="form-group">
                                <label for="note" class="form-label">Gợi ý chứng từ mang theo 1</label>
                                <input type="text" class="form-control" id="txtDocument1" name="txtDocument1" placeholder="Nhập chứng từ mang theo 1" value="{{ $partner->document1 }}">
                              </div>
                              <div class="form-group">
                                <label for="note" class="form-label">Gợi ý chứng từ mang theo 2</label>
                                <input type="text" class="form-control" id="txtDocument2" name="txtDocument2" placeholder="Nhập chứng từ mang theo 2" value="{{ $partner->document2 }}">
                              </div>
                              <div class="form-group">
                                <label for="note" class="form-label">Gợi ý ghi chú</label>
                                <textarea class="form-control" id="txtSgNote" name="txtSgNote" placeholder="Enter Note">{{ $partner->suggest_note }}</textarea>
                              </div>
                              <div class="form-group">
                                ...
                                <select class="form-control select2" id="selGoods" name="selGoods" data-placeholder="Vui lòng chọn loại hàng">
                                  ...
                                  <option value="{{ $gds->goods_id }}" {{ ($partner->suggest_goods==$gds->goods_id)?'selected':'' }}>{{ $gds->sort_name }}</option>
                                  @endforeach
                                </select>
                              </div>
                              <div class="form-group">
                                ...
                                <select class="form-control select2" id="selReceipt" name="selReceipt" data-placeholder="Vui lòng chọn nơi nhận">
                                  ...
                                  <option value="{{ $receipts->place_id }}" {{ ($partner->suggest_receipt==$receipts->place_id)?'selected':''}}>{{ $receipts->name }}</option>
                                  @endforeach
                                </select>
                              </div>
                              <div class="form-group">
                                ...
                                <select class="form-control select2" id="selDeliver" name="selDeliver" data-placeholder="Vui lòng chọn nơi giao">
                                  ...
                                  <option value="{{ $deliv->place_id }}" {{ ($partner->suggest_delivery==$deliv->place_id)?'selected':''}}>{{ $deliv->name }}</option>
                                  @endforeach
                                </select>
                              </div>
                              <div class="form-group">
                                ...
                                <select class="form-control select2" id="selAssistant" name="selAssistant" data-placeholder="Vui lòng chọn người phụ trách">
                                  ...
                                  @foreach($assistant as $ass)
                                    <option value="{{ $ass->user_id }}" {{($partner->suggest_user==$ass->user_id)?'selected':''}}>{{ $ass->nick_name }}</option>
                                  @endforeach
                                </select>
                              </div>
                            </div>
    ...
    <script>
          ...
          $(document).on('click','.postbutton',function(e){
            ...
            data.append('partner_id','{{$partner->partner_id}}')
            ...
            $.ajax({
              ...
              success: function(data){
                if(data.success){
                  ...
                  swal({
                      title: "Có lỗi xảy ra trong quá trình cập nhật chủ hàng",
                      icon: "error",
                      button: "OK",
                      timer: 1000,
                    });
