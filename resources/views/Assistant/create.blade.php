...
@section('content')
    <section class="content-header">
      <div class="row">
        <div class="col-md-12 titleDieuXe">THÊM MỚI PHỤ XE</div>
      </div>
              <!-- back page -->
      <div class="row">
						...
						<div class="nav-tabs-custom">
							...
							<div class="tab-content">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" id="txtTendixe" name="txtTendixe" placeholder="Nhập tên đi xe">
								</div>
								...
								<div class="row">
									<div class="form-group col-md-4 ">
										...
										<div class="input-group date">
											...
											<input class="form-control" placeholder="Nhập Ngày sinh" name="dateNam" value="" type="text">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<!-- <input type="text" class="form-control" id="txtSDT" name="txtSDT" placeholder="Nhập số điện thoại phụ xe"> -->
										<textarea class="form-control" id="txtSDT" name="txtSDT" placeholder="Nhập số điện thoại phụ xe"></textarea>
									</div>
									<div class="form-group">
										<label for="diachi" class="control-label">Địa chỉ :</label>
										<textarea class="form-control" rows="3" placeholder="Nhập địa chỉ phụ xe" id="txtDiachi" name="txtDiachi"></textarea>
									</div>
									<div class="form-group">
