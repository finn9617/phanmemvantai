  ...
  if(freeRule == false){
    ...
    $('#selTaiXe').on('change', function() {
      ...
      if(element){
        ...
        if(element['note'])
          msg += element['note'];
        msg += "\n- Số chuyến đi tháng này: " + numberOfScheduleCurrentMonth;
        if(numberOfScheduleByCarType.length > 0){
          msg += "\n- Số chuyến theo loại xe: ";
          for(let c=0; c < numberOfScheduleByCarType.length; c++){
            msg += "\n   Loại xe: "+numberOfScheduleByCarType[c]['name']+" - Số chuyến: "+numberOfScheduleByCarType[c]['count_row'];
          }
    ...
    $('#selPhuXe').on('change', function() {
      ...
      if(element){
        ...
        // console.log(driverInfo);
        msg += driverInfo;
        // get assistant infor by month
        // let assistantDriverInfo = getDriverInfoForOperating();
        // let numberOfScheduleCurrentMonth = assistantDriverInfo['numberOfScheduleCurrentMonth'];
        // let numberOfScheduleLastMonth = assistantDriverInfo['numberOfScheduleLastMonth'];
        // msg += "\nSố chuyến đi tháng này: " + numberOfScheduleCurrentMonth;
        // msg += "\nSố chuyến đi tháng trước: "+numberOfScheduleLastMonth;
        //
