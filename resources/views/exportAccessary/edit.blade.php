        ...
        <div class="box-body">
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <?php $export=date_create($oA->order_accessary_date)?>
                    <input type="date" class="form-control" id="importDate" name="importDate" value="{{date_format($export,'Y-m-d')}}">
                </div>
                <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-6">
                    ...
                    <select class="form-control select2" id="requester" name="requester" data-placeholder="Chọn tên người yêu cầu">
                        <option></option>
                        @foreach($user as $u)
                            <option value="{{$u->user_id}}" {{ $u->user_id == $oA->user_id ? 'selected' : '' }}>{{$u->nick_name}}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group col-md-6">
                    ...
                    <select class="form-control select2" id="carNum" name="carNum" data-placeholder="Chọn xe">
                        <option></option>
                        @foreach($car as $c)
                            <option value="{{$c->car_id}}" {{ $c->car_id == $oA->car_id ? 'selected' : '' }}>{{$c->car_num}}</option>
                        @endforeach
                    </select>
                </div>
                            ...
                            <tbody id="accessary">
                                @foreach($data as $dt)
                                    <tr class='data'>
                                        ...
                                        <td style="display:none;">{{$dt->accessary_order_detail_id}}</td>
                                        <td style="display:none;">{{$dt->accessary_id}}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
...
<script>
    $(document).ready(function(){
        ...
        $('.save').click(function(e){
            // window.open('{{url("/exportAccessary/print")}}', '_blank', '');
